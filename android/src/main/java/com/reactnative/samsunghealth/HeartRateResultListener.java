...
public class HeartRateResultListener implements
    HealthResultHolder.ResultListener<ReadResult>
{
    ...
    public HeartRateResultListener(SamsungHealthModule module, Callback error, Callback success) {
    ...
    public void onResult(ReadResult result) {
        ...
        try {
            ...
            if (c != null) {
                if (c.getCount() > 0) {
                    ...
                    int col;
                    while (c.moveToNext()) {
                        String uuid = c.getString(c.getColumnIndex(HealthConstants.HeartRate.DEVICE_UUID));
                        ...
                        if (col > -1) {
                            map.putDouble(HealthConstants.HeartRate.HEART_BEAT_COUNT, (double) c.getLong(col));
                        }
        ...
        Log.d(REACT_MODULE, "Heart Rate " + "Results");
